...
using Application.Ultilities.Email;
...
namespace API.Controllers
{
    ...
    public class AuthsController : ApiBaseController
    {
        ...
        {
            //var listToken = _authServices.GetById(id);
        ...
        public async Task<IActionResult> LoginTwoStep(string email, bool rememberMe, string returnUrl = null)
        {
            ...
            await EmailUtil.SendEmailAsync(message);
        ...
        {
            var result = await _authServices.LoginAsync(model, UserId, UserCurrentRole);
        ...
        #endregion login with refresh token
        ...
        {
            throw new NotImplementedException();
            //using var transaction = _adamStoreDbContext.Database.BeginTransaction();
            //try
            //{
            //    string token = "";
        ...
        public async Task<IActionResult> RevokeToken([FromBody] RevokeTokenRequest model)
        {
            ...
            var response = await _authServices.RevokeToken(token);
            if (!response)
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordVM forgotPasswordModel)
        {
            ...
            await EmailUtil.SendLinkForgotPasswordAsync(message, user);
